...
public class MisfiredTest {
	...
	public void testCreateSleepJob() throws Exception {
	    ...
	    Trigger sleepJob5000Trigger = newTrigger() 
	        .withIdentity("sleepJob5000")
	        .withSchedule(
	        		simpleSchedule()
	        		.withRepeatCount(-1)
	...
	public void testMisfiredWithJdbcJobStore() throws Exception {
	    ...
	    Trigger longJobTrigger = newTrigger() 
	        .withIdentity("longJobTrigger")
	        .withSchedule(simpleSchedule())
	        .startAt(startTime)
	        .build();
	    Trigger misfiredJobTrigger = newTrigger() 
	        .withIdentity("misfiredJobTrigger")
	        .withSchedule(
	        		simpleSchedule()
	        		.withRepeatCount(-1)
