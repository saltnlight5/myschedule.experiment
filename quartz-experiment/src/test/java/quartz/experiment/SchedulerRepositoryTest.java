...
public class SchedulerRepositoryTest {
	/**
	 * Within the same JVM, you can not instantiate multiple Quartz scheduler with the same name,
	 * in regardless of the instanceId! No warning is given, and it will reuse existing scheduler
	 * when using StdSchedulerFactory, even if you supply different properties file!
	 * 
